...
//	}
	 ...
	 * String update(BoardDTO boardDTO, RedirectAttributes attr,HttpServletRequest
	 * request) throws Exception { request.setCharacterEncoding("utf-8"); int r =
	 * boardService.update(boardDTO); // 수정에 성공하면 목록보기로 이동 if (r > 0) {
	 * attr.addFlashAttribute("msg", "수정에 성공 하였습니다."); return "redirect:list"; } //
	 * 수정에 실패하면 수정보기 화면으로 이동 return "redirect:update?bno=" + boardDTO.getBno(); }
	 */
